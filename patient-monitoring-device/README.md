# IoT Hub Raspberry Pi 2 / 3 / Zero Client application

> This application was originally written to work with a BME280 temperature and humidity sensor. It works equally well with other sensors, such as ones that measure patient vitals.
